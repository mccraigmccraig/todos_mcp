defmodule TodosMcpWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TodosMcpWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TodosMcpWeb.Gettext, "errors", msg, opts)
    end
  end
